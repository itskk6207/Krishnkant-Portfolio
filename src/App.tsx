      ...
      <div className="min-h-screen bg-background transition-colors duration-300">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="shrink-0">
                <h3 className="tracking-tight">Krishnkant Kumar</h3>
              </div>
        ...
        <footer className="bg-secondary/10 py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="mb-4">Krishnkant Kumar</h3>
            <p className="text-muted-foreground mb-6">
              Computer Application Student | Full-Stack Developer | Innovative Problem Solver
            </p>
            <p className="text-sm text-muted-foreground">
              © 2025 Krishnkant Kumar. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
