...
import profileImage from "../assets/KK.jpg"; // Make sure this file exists in src/assets/
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-lg">
                  Computer Application Student & Full-Stack
                ...
                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Master's student specializing in full-stack
                  development, IoT solutions, and building
                  scalable web applications with modern
                  technologies.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                ...
                onClick={() => {
                  ...
                  link.download = "Krishnkant_Kumar_Resume.pdf";
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "http://www.linkedin.com/in/imkrishnkant",
                    "_blank",
                  )
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  (window.location.href =
                    "mailto:krishnkant2803@gmail.com")
                }
              >
            ...
            <div className="relative">
              ...
              <div className="relative z-10 group">
                <div className="relative w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border-4 border-background/50 shadow-2xl">
                  <img
                    src={profileImage}
                    alt="Krishnkant Kumar - Computer Application Student & Developer"
